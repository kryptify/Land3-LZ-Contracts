...
contract RemoteUpdater is NonblockingLzApp, ReentrancyGuard, Pausable {
    ...
    // update owner of NFT
    function updateOwnerOfNFT(uint16 _dstChainId, uint _tokenId, address _newOwner) public payable nonReentrant whenNotPaused {
